...
class Invoice extends Model
{
    ...
    protected $fillable = ['name', 'num_ticket', 'num_ticket_store', 'notes', '_created_by', '_workpoint_from', '_workpoint_to', '_type', '_state', 'printed'];
    ...
    public function to(){
        return $this->belongsTo('App\Models\Warehouses', '_warehouse_to');
    }

    public function from(){
        return $this->belongsTo('App\Models\Warehouses', '_warehouse_from');
    }
